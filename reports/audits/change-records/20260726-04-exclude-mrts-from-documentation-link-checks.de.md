...
| Issue oder Pull Request | Framework-Task-Branch `agent/remediate-active-framework-findings-20260726`; ein Draft-PR wird erst nach finaler lokaler Validierung und dem Push des exakten Heads erstellt. |
