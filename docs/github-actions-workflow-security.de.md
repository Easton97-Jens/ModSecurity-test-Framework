...
| `github/codeql-action` | [github/codeql-action](https://github.com/github/codeql-action) | v4.37.7 | ff2f1c621b7f889edc0d3c761ac2e6a3f8cdb0dd | MIT | Führt die begrenzte CodeQL-Analyse und den vertrauenswürdigen SARIF-Upload aus. |
