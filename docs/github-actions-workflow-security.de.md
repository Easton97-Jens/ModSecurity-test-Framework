...
| `github/codeql-action` | [github/codeql-action](https://github.com/github/codeql-action) | v4.37.8 | db488ddef3bf6cb639b32c2e9a7c0a7ea8271d28 | MIT | Führt die begrenzte CodeQL-Analyse und den vertrauenswürdigen SARIF-Upload aus. |
