...
|---|---:|---|---|
| 1 | 35 | REQUEST_URI(7), REQUEST_HEADERS_NAMES(5), ARGS:a(4), REQUEST_COOKIES_NAMES(4), ARGS:param1(2) | imported:16, unknown:2, xfail:17 |
| 2 | 69 | ARGS:q(18), REQUEST_BODY(9), ARGS_NAMES(7), ARGS:test(6), XML(4) | imported:28, unknown:4, xfail:37 |
