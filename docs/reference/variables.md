...
| Expat | not_applicable | The Framework does not acquire Expat; the Parent consumes the reviewed immutable commit in its connector-scoped runtime provisioner. |
