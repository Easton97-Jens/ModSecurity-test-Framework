...
| Expat | not_applicable | Das Framework beschafft Expat nicht selbst; der Parent verwendet den geprüften unveränderlichen Commit in seinem connectorbezogenen Runtime-Provisioner. |
