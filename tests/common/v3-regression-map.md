...
| `test/test-cases/regression/secruleengine.json` | ModSecurity_V3 | v3/master observed 3.0.15 | actions | SecAction and rule-engine behavior | yes | no | yes | `tests/cases/phases/v3_secaction_block.yaml` | imported | actions, phase2 | DetectionOnly and disabled-engine branches remain mapped |
...
| `test/test-cases/regression/variable-ARGS_NAMES.json` | ModSecurity_V3 | v3/master observed 3.0.15 | collections | Request argument-name collection, including GET names `key1` and `key2` | yes | no | yes | `tests/cases/phases/v3_args_names_get_block.yaml` | imported | collections, args-names, query-args, phase2 | Duplicate and POST name branches remain mapped only |
