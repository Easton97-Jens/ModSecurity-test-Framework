...
TRAEFIK_SHA256="52cd039a34258dd61c617a95d69252bc6bcae27c520f338186c31c7fef8f6394"
...
# Canonical OpenSSL release provenance for Framework hosts that explicitly use
# an external OpenSSL source.  The tuple is intentionally independent of a
# system installation and is the single source for NGINX's current H3 profile.
OPENSSL_VERSION="4.0.1"
OPENSSL_TAG="openssl-4.0.1"
OPENSSL_ARCHIVE_NAME="$OPENSSL_TAG.tar.gz"
OPENSSL_SOURCE_URL="https://github.com/openssl/openssl/releases/download/$OPENSSL_TAG/$OPENSSL_ARCHIVE_NAME"
OPENSSL_SHA256="2db3f3a0d6ea4b59e1f094ace2c8cd536dffb87cdc39084c5afa1e6f7f37dd09"

# AWS-LC is a reviewed, immutable future build candidate.  No current
...
# by selecting a profile at build time.  The H3 profile uses the generic pinned
# OpenSSL source rather than silently relying on whichever system TLS library
# is installed.  The source is only fetched/extracted by prepare-nginx-build.sh
...
# R_2_8_3 tag; do not replace it with a moving branch or a latest-release
# lookup.
EXPAT_GIT_REF="92810461043fce37e70079b37ab1f04490a8f039"
...
CI_CANONICAL_NODE_VERSION="26.8.2"
...
CI_ACTION_CODEQL_VERSION="v4.38.0"
...
CI_SECURITY_TOOL_OSV_SCANNER_VERSION="v2.5.1"
CI_SECURITY_TOOL_OSV_SCANNER_COMMIT="c84fa4568f2526d0333e9a914ea8a0a5f74ad68b"
CI_SECURITY_TOOL_OSV_SCANNER_ASSET_NAME="osv-scanner_linux_amd64"
CI_SECURITY_TOOL_OSV_SCANNER_SHA256="f9f25499a2c8cc367b3af45df2ea7eeca7fbccceab9c35079968f4b3652194be"
...
CI_SECURITY_TOOL_ZIZMOR_VERSION="v1.30.1"
CI_SECURITY_TOOL_ZIZMOR_COMMIT="99a054ed9283c90abdd2d5b9fb5101d27dde9783"
CI_SECURITY_TOOL_ZIZMOR_ASSET_NAME="zizmor-x86_64-unknown-linux-gnu.tar.gz"
CI_SECURITY_TOOL_ZIZMOR_SHA256="e65324f4430c2717591937edcec90ccbefaf14c174f8ec9415e03ca875b46e1a"
...
CI_SECURITY_TOOL_RUFF_VERSION="0.16.6"
CI_SECURITY_TOOL_RUFF_COMMIT="22f65a2ab5052990503985c7c794de37598d531e"
CI_SECURITY_TOOL_RUFF_ASSET_NAME="ruff-x86_64-unknown-linux-gnu.tar.gz"
CI_SECURITY_TOOL_RUFF_SHA256="0696335ef16615d8c7445ad438750eb0f55b3da6f153df21265a7c6d5750254f"
CI_SECURITY_TOOL_PYRIGHT_REPOSITORY="microsoft/pyright"
CI_SECURITY_TOOL_PYRIGHT_VERSION="1.1.414"
CI_SECURITY_TOOL_PYRIGHT_COMMIT="a28cce4077d87b80bead12de809f79845e39c8ba"
CI_SECURITY_TOOL_PYRIGHT_ASSET_NAME="pyright.tgz"
CI_SECURITY_TOOL_PYRIGHT_SHA256="bf5f473f6167c0d14175492c3263d783b4489a6956e1c06c18e15228e3a3fa42"
...
ci_capture_canonical_active_upstream_pins() {
    ...
    CI_ACTIVE_PIN_CRS_RULE_FILE_SHA256=$CRS_RULE_FILE_SHA256
    ...
    CI_ACTIVE_PIN_OPENSSL_VERSION=$OPENSSL_VERSION
    CI_ACTIVE_PIN_OPENSSL_TAG=$OPENSSL_TAG
    CI_ACTIVE_PIN_OPENSSL_ARCHIVE_NAME=$OPENSSL_ARCHIVE_NAME
    CI_ACTIVE_PIN_OPENSSL_SOURCE_URL=$OPENSSL_SOURCE_URL
    CI_ACTIVE_PIN_OPENSSL_SHA256=$OPENSSL_SHA256
    CI_ACTIVE_PIN_AWS_LC_REPOSITORY=$AWS_LC_REPOSITORY
    CI_ACTIVE_PIN_AWS_LC_TAG=$AWS_LC_TAG
    CI_ACTIVE_PIN_AWS_LC_COMMIT=$AWS_LC_COMMIT
...
ci_require_inherited_canonical_upstream_pins() {
    ...
    for ci_inherited_pin_entry in \
        ...
        "OPENSSL_TAG:$OPENSSL_TAG" \
        "OPENSSL_ARCHIVE_NAME:$OPENSSL_ARCHIVE_NAME" \
        "OPENSSL_SOURCE_URL:$OPENSSL_SOURCE_URL" \
        "OPENSSL_SHA256:$OPENSSL_SHA256" \
        "AWS_LC_REPOSITORY:$AWS_LC_REPOSITORY" \
        "AWS_LC_TAG:$AWS_LC_TAG" \
...
ci_require_canonical_active_upstream_pins() {
    ...
    ci_require_canonical_active_pin CRS_RULE_FILE_SHA256 "$CRS_RULE_FILE_SHA256" "$CI_ACTIVE_PIN_CRS_RULE_FILE_SHA256" || return 77
    ...
    ci_require_canonical_active_pin OPENSSL_VERSION "$OPENSSL_VERSION" "$CI_ACTIVE_PIN_OPENSSL_VERSION" || return 77
    ci_require_canonical_active_pin OPENSSL_TAG "$OPENSSL_TAG" "$CI_ACTIVE_PIN_OPENSSL_TAG" || return 77
    ci_require_canonical_active_pin OPENSSL_ARCHIVE_NAME "$OPENSSL_ARCHIVE_NAME" "$CI_ACTIVE_PIN_OPENSSL_ARCHIVE_NAME" || return 77
    ci_require_canonical_active_pin OPENSSL_SOURCE_URL "$OPENSSL_SOURCE_URL" "$CI_ACTIVE_PIN_OPENSSL_SOURCE_URL" || return 77
    ci_require_canonical_active_pin OPENSSL_SHA256 "$OPENSSL_SHA256" "$CI_ACTIVE_PIN_OPENSSL_SHA256" || return 77
    ci_require_canonical_active_pin AWS_LC_REPOSITORY "$AWS_LC_REPOSITORY" "$CI_ACTIVE_PIN_AWS_LC_REPOSITORY" || return 77
    ci_require_canonical_active_pin AWS_LC_TAG "$AWS_LC_TAG" "$CI_ACTIVE_PIN_AWS_LC_TAG" || return 77
    ci_require_canonical_active_pin AWS_LC_COMMIT "$AWS_LC_COMMIT" "$CI_ACTIVE_PIN_AWS_LC_COMMIT" || return 77
...
ci_validate_https_runtime_url_config() {
    ...
    [ "$OPENSSL_TAG" = "openssl-$OPENSSL_VERSION" ] || {
        ci_blocked "OPENSSL_TAG must be derived from OPENSSL_VERSION"
        return 77
    }
    [ "$OPENSSL_ARCHIVE_NAME" = "$OPENSSL_TAG.tar.gz" ] || {
        ci_blocked "OPENSSL_ARCHIVE_NAME must be derived from OPENSSL_TAG"
        return 77
    }
    [ "$OPENSSL_SOURCE_URL" = "https://github.com/openssl/openssl/releases/download/$OPENSSL_TAG/$OPENSSL_ARCHIVE_NAME" ] || {
        ci_blocked "OPENSSL_SOURCE_URL must be derived from the reviewed OpenSSL release tuple"
        return 77
    }
    [ "$NGINX_QUIC_TLS_VERSION" = "$OPENSSL_VERSION" ] || {
        ci_blocked "NGINX_QUIC_TLS_VERSION must match OPENSSL_VERSION"
        return 77
    }
    [ "$NGINX_QUIC_TLS_ARCHIVE_NAME" = "$OPENSSL_ARCHIVE_NAME" ] || {
        ci_blocked "NGINX_QUIC_TLS_ARCHIVE_NAME must match OPENSSL_ARCHIVE_NAME"
        return 77
    }
    [ "$NGINX_QUIC_TLS_SOURCE_URL" = "$OPENSSL_SOURCE_URL" ] || {
        ci_blocked "NGINX_QUIC_TLS_SOURCE_URL must match OPENSSL_SOURCE_URL"
        return 77
    }
    [ "$NGINX_QUIC_TLS_SOURCE_SHA256" = "$OPENSSL_SHA256" ] || {
        ci_blocked "NGINX_QUIC_TLS_SOURCE_SHA256 must match OPENSSL_SHA256"
        return 77
    }
    ci_require_https_url "$OPENSSL_SOURCE_URL" OPENSSL_SOURCE_URL || return 77
    ci_require_https_url "$NGINX_QUIC_TLS_SOURCE_URL" NGINX_QUIC_TLS_SOURCE_URL || return 77
    ci_require_https_github_repo_url "$AWS_LC_REPOSITORY" AWS_LC_REPOSITORY || return 77
    ci_require_full_git_commit "$AWS_LC_COMMIT" AWS_LC_COMMIT || return 77
...
export NGINX_SOURCE_MODE NGINX_SOURCE_REPO_URL NGINX_GITHUB_REPO NGINX_RELEASE_TAG NGINX_SOURCE_GIT_REF NGINX_RELEASE_ASSET_NAME NGINX_DOWNLOAD_URL NGINX_SHA256 NGINX_SHA256_WAS_SET NGINX_SHA256_REQUESTED OPENSSL_VERSION OPENSSL_TAG OPENSSL_ARCHIVE_NAME OPENSSL_SOURCE_URL OPENSSL_SHA256 AWS_LC_REPOSITORY AWS_LC_TAG AWS_LC_COMMIT NGINX_QUIC_TLS_LIBRARY NGINX_QUIC_TLS_VERSION NGINX_QUIC_TLS_ARCHIVE_NAME NGINX_QUIC_TLS_SOURCE_URL NGINX_QUIC_TLS_SOURCE_SHA256
